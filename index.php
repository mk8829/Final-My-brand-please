            ...
            <div class="gs-process__grid gs-grid">
              <div class="gs-process__card gs-card">
                <div class="gs-process__card-inner">
                  ...
                  <div class="gs-process__card-face gs-process__card-back">
                    <img src="<?php echo url('assets/imgs/how-it-works/Define-Your-Offerings-min-2048x1244.webp'); ?>" alt="Order samples and determine products">
                  </div>
                </div>
              </div>
              ...
              <div class="gs-process__card gs-card">
                <div class="gs-process__card-inner">
                  ...
                  <div class="gs-process__card-face gs-process__card-back">
                    <img src="<?php echo url('assets/imgs/how-it-works/Choose-Your-Product-Components-min-2048x1244.webp'); ?>" alt="Choose product packaging components">
                  </div>
                </div>
              </div>
              ...
              <div class="gs-process__card gs-card">
                <div class="gs-process__card-inner">
                  ...
                  <div class="gs-process__card-face gs-process__card-back">
                    <img src="<?php echo url('assets/imgs/how-it-works/Label-Design-Printing-min-2048x1243.webp'); ?>" alt="Label design and printing">
                  </div>
                </div>
              </div>
              ...
              <div class="gs-process__card gs-card">
                <div class="gs-process__card-inner">
                  ...
                  <div class="gs-process__card-face gs-process__card-back">
                    <img src="<?php echo url('assets/imgs/how-it-works/Finishing-Touches-min-768x467.webp'); ?>" alt="Finishing touches for private label packaging">
                  </div>
                </div>
              </div>
            </div>
        ...
        <section class="global-presence section-spacing-120 rr-ov-hidden js-global-presence">
          <div class="container-fluid" id="section-map">
            ...
            <div class="global-map-stage wow fadeInUp" data-wow-delay=".3s">
              <img class="global-map-image" src="<?php echo url('assets/imgs/home/map2.webp'); ?>" alt="World map">
        ...
        <section class="reviews-section">
          <div class="row align-items-center">
            <div class="col-12 col-md-5 ">
              ...
              <p class="rv-sub">Real feedback from our private label partners</p>
            </div>
              ...
              <?php
                ...
                <article class="office-card wow fadeInUp" data-wow-delay=".<?php echo (int) round($officeDelay * 10); ?>s">
                  ...
                  <div class="office-card__body">
                    <span class="office-card__eyebrow"><i class="fa-solid fa-location-dot"></i> Regional Office</span>
  ...
  window.addEventListener('load', function () {
    ...
    if (window.AOS && typeof window.AOS.init === 'function') {
      ...
      (function initGlobalMapSequence() {
        const section = root.querySelector('.js-global-presence');
        const stage = root.querySelector('.global-map-stage');
        if (!section || !stage || window.innerWidth <= 991) return;
...
<?php
  $partnerLogos = [
    ['src' => 'assets/imgs/partner-logos/31.png', 'alt' => '31'],
