...
<<<<<<< HEAD
      ...
      ali: "/assets/imgs/about/aliba.png"
=======
      tp: "/assets/imgs/about/trustPilot.png",
      goog: "/assets/imgs/about/google.png",
      ali: "/assets/imgs/about/alibaba.png"
...
>>>>>>> 89c240c4f640b20f99fb4271d60b656e14d19e9d
    ...
    function resetProg() {
      ...
      autoT = setInterval(window.next, DUR);
    }
    ...
    window.next = function () {
      window.goTo((cur + 1) % list.length);
    };

    window.prev = function () {
      window.goTo((cur - 1 + list.length) % list.length);
    };
